...
public class Game extends Frame implements ActionListener {
    ...
    Game() {
        ...
        Color backgroundColor = new Color(173, 216, 205);
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (ae.getSource() == b[i][j]) {
                    ...
                    b[i][j].setBackground(backgroundColor);
                }
            }
        }
        checkwin();
